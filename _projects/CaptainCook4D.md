...
img: assets/img/publication_preview/CaptainCook4D.gif
importance: 3
category: datasets
---
...
<div align="center">
  ...
  <a href="https://arxiv.org/abs/2312.14556">
    <img src="https://img.shields.io/badge/paper-arxiv-red" alt="Paper (arXiv)">
  </a>
  <a href="https://captaincook4d.github.io/captain-cook/#citation">
    <img src="https://img.shields.io/badge/bibtex-citation-blue" alt="BibTeX citation">
  </a>
</div>
...
<div align="center" class="my-3">
  <img
    src="https://raw.githubusercontent.com/CaptainCook4D/captain-cook/main/static/images/TitleImage.svg"
    alt="Overview"
...
To this end, we collected a new egocentric 4D dataset, CaptainCook4D, comprising 384 recordings (94.5 hrs) of people performing recipes in real kitchen environments.
...
<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/user-attachments/assets/d366002a-1832-48f7-8bc4-2a7774d4d4ef" type="video/mp4">
...
<p class="subtitle has-text-centered">
  ...
  <span class="recipe_description">
    In the recipe <span class="recipe"><b>butter corn cup</b></span>,
    ...
    whereas the subsequent three snippets display the result of inducing errors by spilling out corn from the bowl while mixing.
  </span>
</p>

<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/user-attachments/assets/c65c4089-1421-4494-b1ba-cbe072a71fa6" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
<p class="subtitle has-text-centered">
  ...
  <span class="recipe_description">
    In the recipe <span class="recipe"><b>scrambled eggs</b></span>,
    the first two video snippets exhibit the outcome of correctly following the instruction
...
<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/user-attachments/assets/9a6b7470-5284-49fe-9616-0e3458ded6b4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
<p class="subtitle has-text-centered">
  ...
  <span class="recipe_description">
    In the recipe <span class="recipe"><b>spicy tuna avacado wraps</b></span>,
    the first two video snippets exhibit the outcome of correctly following the instruction
...
<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/user-attachments/assets/b5bdac1c-522b-4801-a864-55c28039a3c3" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
<p class="subtitle has-text-centered">
  ...
  <span class="recipe_description">
    In the recipe <span class="recipe"><b>mug cake</b></span>,
    the first two video snippets exhibit the outcome of correctly following the instruction
...
<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/user-attachments/assets/4e45a905-4ad5-4818-bc0e-0d76aa3ed740" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
<p class="subtitle has-text-centered">
  <span class="recipe">Technique Error:</span>
  <span class="recipe_description">
    In the recipe <span class="recipe"><b>cucumber raita</b></span>,
    the first two video snippets exhibit the outcome of correctly following the instruction
...
<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/Error-Dataset/Error-Dataset/assets/130110495/d7a0f0d8-8ed2-4d37-ba0b-8b93a595a9c0" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
You can find the task graphs for the following tasks in the dataset here:  
[Task Graphs](https://github.com/Error-Dataset/annotations)

<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/user-attachments/assets/f32e37c6-adb9-4bd8-952b-7effa3de4b01" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
<div align="center" class="my-3">
  <img
    src="https://raw.githubusercontent.com/CaptainCook4D/captain-cook/main/static/images/RecipeTimeline.svg"
    alt="Annotation Overview"
    style="max-width: 100%; width: 100%; height: auto;"
  >
</div>
...
<div align="center" class="my-3">
  <video controls playsinline style="max-width: 100%; width: 100%; height: auto;">
    <source src="https://github.com/user-attachments/assets/87cae353-536b-48ad-942e-5eeb7c725089" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
...
<div align="center" class="my-3">
  <img
    src="https://raw.githubusercontent.com/CaptainCook4D/captain-cook/main/static/images/ErrorCategories.svg"
...
<div align="center" class="my-3">
  <img
    src="https://raw.githubusercontent.com/CaptainCook4D/captain-cook/main/static/images/ErrorRecognitionBaseline.svg"
    alt="Supervised Error Recognition"
    style="max-width: 100%; width: 100%; height: auto;"
  >
</div>
...
<div align="center" class="my-3">
  <img
    src="https://raw.githubusercontent.com/CaptainCook4D/captain-cook/main/static/images/ZeroShotErrorRecognition.svg"
    alt="Zero Shot Error Recognition"
    style="max-width: 100%; width: 100%; height: auto;"
  >
</div>
...
<div align="center" class="my-3">
  <img
    src="https://raw.githubusercontent.com/CaptainCook4D/captain-cook/main/static/images/MultiStepLocalizationQualitativeResults.svg"
    alt="Multi Step Localization"
    style="max-width: 100%; width: 100%; height: auto;"
  >
</div>
...
**Feb 2025:** [Task Graph Maximum Likelihood Estimation for Procedural Activity Understanding in Egocentric Videos](https://arxiv.org/abs/2502.17753)  
**Oct 2024:** [ProMQA: Question Answering Dataset for Multimodal Procedural Activity Understanding](https://arxiv.org/abs/2410.22211)  
...
<div align="center" class="my-3">
  <img
    src="https://github.com/user-attachments/assets/2131cf50-07cf-4d7d-b451-4beb6576fc22"
    alt="Pre-rebuttal NeurIPS scores"
    style="max-width: 100%; width: 100%; height: auto;"
  >
</div>
